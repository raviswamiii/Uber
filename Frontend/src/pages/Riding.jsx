...
export const Riding = () => {
  return (
    <div className=" relative h-screen">
      <Link to={"/home"}>
        <GoHome className="absolute bg-white text-4xl p-2 rounded-full right-3 top-3" />
      </Link>
      ...
      <div className="h-1/2 overflow-hidden p-4">
        ...
        <div>
          <div className="flex items-center border-bottom gap-4  py-4 px-2">
        ...
        <button className="bg-green-600 w-full text-white rounded-md py-2 mt-4 text-center">
          Make a Payment
        </button>
      </div>
    </div>
